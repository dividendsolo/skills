...
### 5. Read the tells
From `playbook.md`, name which **top tells** and which **bottom tells** are firing, each tied to a concrete fact about this business.
...
- **`playbook.md` is the source of truth** for the tells and sectors - keep it growing there, not here.
